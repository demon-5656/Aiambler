...
.PHONY: all native test test-native bench-agent bench-golden bench-multistep bench-syntax bench-tokens clean
...
bench-golden: native
	python3 benchmarks/golden_tasks.py --runs 20 --tiktoken --encoding cl100k_base
